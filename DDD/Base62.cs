...
namespace DDD
{
    ...
    public static class Base62
    {
        ...
        /// <summary>
        /// Generates a new Base62 encoded Guid. Benchmarked to take about 5us to generate.
        /// </summary>
        /// <returns></returns>
        public static string NewBase62Guid()
        {
            return ToBase62( Guid.NewGuid().ToByteArray() );
        }
